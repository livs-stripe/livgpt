...
- "price" is the integer amount in cents exactly as listed. Copy id, imageUrl, currency, sellerId and sellerName verbatim from the catalog. imageUrl is the /mock-catalog/images/... photo path, never the product page link.
